...
<%--                                                <i class=" glyphicon glyphicon-check"></i></button>--%>
                                            <a href="assign/to/role/page.html?adminId=${admin.id}&pageNum=${pageInfo.pageNum}&keyword=${param.keyword}" class="btn btn-success btn-xs"> <i
                                            ...
                                            <a href="admin/remove/${admin.id}/${pageInfo.pageNum}/${param.keyword}.html"
